...
Chatbox opens a browser sign-in for your UnifAPI workspace. Read-only — no API key to paste.

### 3. Try it with Chatbox
...
<sub>Topics: Chatbox MCP · connect UnifAPI to Chatbox · Chatbox MCP server · UnifAPI Chatbox setup · Chatbox public data API</sub>
